...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'xgram-secret-key')
...
def api_send_message():
    ...
    if 'file' in request.files:
        ...
        if file and file.filename:
            ...
            full_path = os.path.join(app.config['UPLOAD_FOLDER'], folder, unique_name)
